...
namespace UnitTests
{
	...
	{
		Assignment5.Task1.ISet set = new Assignment5.Task1.LinkedSet1();
		...
		public void Equals()
		{
			Assignment5.Task1.ArraySet otherSet = new Assignment5.Task1.ArraySet();
	...
	{
		Assignment5.Task2.ISet<double> set = new Assignment5.Task2.ArraySet<double>();
